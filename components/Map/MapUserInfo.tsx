...
export default function MapUserInfo(props: Props) {
    return (
        <div className="absolute z-[400] flex-center-y bottom-[120px] inset-x-4 bg-white p-2 rounded-3xl gap-2">
            <div className="image-container w-[84px] aspect-square ">
                <Image src="/assets/images/banner.png" className="image rounded-[20px]" alt="avatar" layout="fill" />
            </div>
            <div className="flex flex-col gap-1">
                <h2 className="text-neutral-100">Linda, 22t</h2>
