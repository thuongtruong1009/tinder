        ...
        <Transition appear show={isOpen} as={Fragment}>
            <DialogContainer as="div" className="relative z-[1000]" onClose={onClose}>
                ...
                <Transition.Child
                    ...
                    enterFrom="top-2/4 opacity-0"
                    enterTo="top-0 opacity-100"
                    leave="transition-all duration-200"
                    leaveFrom="top-0 opacity-100"
                    leaveTo="top-2/4 opacity-0"
                >
                    <div className="fixed inset-0 overflow-y-auto -translate-x-[3px]">
                        <div className="flex items-end justify-center min-h-full px-4 text-center">
                            <DialogContainer.Panel className="w-full max-w-[377px] px-4 py-12 space-y-10 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-t-[40px] min-h-[500px]">
